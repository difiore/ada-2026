...
## Challenge: Sending Emails {.unnumbered}

### Sending an Email Using the {emayili} package {.unnumbered}
...
### Sending an Email using the {mailR} package {.unnumbered}
...
### Sending an Email using the {blastula} package {.unnumbered}
...
### Sending an Email using the {sendmailR} package {.unnumbered}
...
## Challenge: Sending an SMS or MMS Text
...
### Using Textbelt to send text messages {.unnumbered}
...
### Checking the status of a sent message via {curl}
