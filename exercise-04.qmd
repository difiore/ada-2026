# Exercise 04 {.unnumbered}

# Program a Word Game {.unnumbered}
...
The assignment and steps below were inspired by [this fun blog post](https://statisticaloddsandends.wordpress.com/2022/01/18/playing-wordle-in-r/)... but before you reference it or other online sites, try to tackle this coding exercise on your own.

### Preliminaries {.unnumbered}

- Set up a new ***GitHub*** repo in you or your partner's ***GitHub*** workspace named "exercise-04" and clone that down to both of your computers as a new ***RStudio*** project. The instructions outlined as **Method 1** in [**Module 6**](#module-06) will be helpful. Make sure that both you and your partner are collaborators on the repo and that you add me as a collaborator as well (my ***GitHub*** username is "difiore").
...
- Create a new **Quarto** document, called "wordle.qmd". In this, you do your best to recreate all of the wordplay used in Wordle.

## Challenge {.unnumbered}

### Program your own **Wordle** Game {.unnumbered}
