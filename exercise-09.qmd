...
- Set up a new ***GitHub*** repo in your ***GitHub*** workspace named "exercise-9" and clone that down to your computer as a new ***RStudio*** project. The instructions outlined as **Method 1** in [**Module 6**](#module-06) will be helpful.

## Challenge {.unnumbered}

#### Step 1 {.unnumbered}

- Using the {tidyverse} `read_csv()` function, load the "KamilarAndCooperData.csv" dataset from ***GitHub*** at [this URL](https://github.com/difiore/ada-datasets/main/KamilarAndCooperData.csv) as a "tibble" named **d**.
