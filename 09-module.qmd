...
> **NOTE:** The following code block chains together a set of data wrangling commands using the native pipe operator (`|>`), which we have not covered yet, but is discussed in detail in [**Module 10**](#module-10).
