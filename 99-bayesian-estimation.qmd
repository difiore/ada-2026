...
- standard deviation of the residuals is typically around ~0.1 (but with a long tail)
...
### $\hat{R}$: The Gelman-Rubin Convergence Diagnostic
...
The Bayesian credible interval has the interpretation that most people *intuitively* want from a confidence interval — but which the confidence interval formally does not provide.
