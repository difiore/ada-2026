...
You will collectively take the class through your presentation/module during our meeting final class meeting period and final exam period. We will aim for ~9 presentations total of ~15-20 minutes each, including time for questions. I may try to also record these video presentations and share them via the Canvas site.
...
> **NOTE:** The **Miscellany** module on [Building Custom ***R*** Packages](https://difiore.github.io/ada-2026/99-r-packages.html) takes the user through all of the step of package development, so use it as a resource! We will work through this module during our one of our last class periods.

Additionally, by the due date for this assignment -- the last day of the formal final exam period -- one group member should upload the final **R Package**'s bundled "\*.tar.gz" file to the **Canvas** site for the course, and your group should collectively upload your entire ***R Package*** project to a ***GitHub*** repository and share with your instructors, via the assignment submission text field on Canvas, the URL to that repository.

> **NOTE:** We should be able to CLONE your repository and see all of the components associated with your package development and also to build your package ourselves.
