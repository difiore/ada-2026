...
- Using the {tidyverse} `read_tsv()` function, load the "Mammal_lifehistories_v2.txt" dataset from [this URL](https://raw.githubusercontent.com/difiore/ada-datasets/main/Mammal_lifehistories_v2.txt) as a "tibble" named **d**. As discussed in class, this is data set that compiles life history and other variables for over 1400 species of placental mammals from 17 different Orders.
