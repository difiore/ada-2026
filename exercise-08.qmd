...
- Set up a new ***GitHub*** repo in your ***GitHub*** workspace named "exercise-08" and clone that down to your computer as a new ***RStudio*** project. The instructions outlined as **Method 1** in [**Module 6**](#module-06) will be helpful.
