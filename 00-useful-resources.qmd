...
-   Baumer, B.S., Kaplan, D.T., & Horton, N.J. (2021). *Modern Data Science with R* (2nd Edition). Chapman & Hall/CRC. [link to web version](https://mdsr-book.github.io/mdsr2e/)
...
-   Wickham, H., Çetinkaya-Rundel, M., & Grolemund, G. (2023). *R for Data Science* (2nd Edition). O'Reilly Media, Inc. [link to web version](https://r4ds.hadley.nz/)
...
-   [Posit Cloud](https://posit.cloud/) (R, Python) (browser)
...
#### ***R*** Packages, ***Quarto***/***RMarkdown***, and Reproducible Research {.unnumbered}
